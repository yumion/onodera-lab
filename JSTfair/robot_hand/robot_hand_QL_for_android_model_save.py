...
discount = 0.99  # 時間割引率
lr = 0.5  # 学習係数
MAX_STEPS = 50  # 1試行のstep数cartpoleは195steps立ち続ければ終わり
NUM_EPISODES = 50  # 最大試行回数
AREA_THRESH = 35  # 赤色物体面積の閾値．0~100で規格化してある
...
class  Environment:
    ...
    def __init__(self):
        self.num_states = 6  # 課題の状態の数(面積と重心(x,y)と、それぞれの変化量で6つ)
        self.num_actions = 7  # ロボットハンドの行動（前進，後退，右旋回，左旋回，握る，離す，止まる）
